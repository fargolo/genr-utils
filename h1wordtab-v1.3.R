...
# H1Word Tab
# To do:
# Verificar tipo das variaveis
# Verificar se categoricas tem pelo menos 2 levels
# Usar kruskal.test (NUMERICA ~ CATEGORICA, data = data) para Nao normais numericas

h1wordtab <- function (data,var.num,var.cat,var.group, dec.plat= 1,dec.p = 3){
